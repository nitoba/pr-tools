...
| Defaults | DEFAULT_PROVIDERS, DEFAULT_*_MODEL |
...
- Remove duplicated functions: log_*, set_env_var, ensure_env_key_comment, prompt_value, prompt_yn, test_azure_pat, test_provider_key, validate_dependencies, load_config
