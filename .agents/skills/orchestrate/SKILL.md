...
| Terra | The assignment benefits from a stronger collaborative peer, a higher coding ceiling than Luna, or delegated coordination of its own independent workstream.                                                                                      | `xhigh` by default.                                                                                   | Routine leaf work that Luna xhigh or max can complete.                  |
...
- `senior_critic` — `gpt-5.6-sol`, reasoning `high` — senior-review leaf
```
...
### Collaborative workstream owner — Terra xhigh
